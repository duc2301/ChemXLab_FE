...
const completeElementsData = [
  // Period 1
  {
    ...
    yearDiscovered: "1766",
    description:
      "Nguyên tố phổ biến nhất trong vũ trụ, chiếm 75% khối lượng vũ trụ.",
    applications:
      "Sản xuất amoniac, nhiên liệu tên lửa, pin nhiên liệu, thực phẩm (hydro hóa dầu)",
  },
  {
    number: 2,
    symbol: "He",
    ...
    yearDiscovered: "1868",
    description:
      "Khí hiếm nhẹ nhất thứ hai, không màu, không mùi và không cháy.",
  ...
  // Period 2
  {
    ...
    applications:
      "Pin lithium-ion, hợp kim nhôm, thuốc chống trầm cảm, mỡ bôi trơn",
  },
  {
    number: 4,
    symbol: "Be",
    ...
    applications:
      "Hợp kim hàng không vũ trụ, cửa sổ tia X, lò phản ứng hạt nhân, dụng cụ quang học",
  },
  {
    number: 5,
    symbol: "B",
    ...
    applications:
      "Thủy tinh borosilicate, chất tẩy rửa, thuốc diệt côn trùng, vật liệu siêu cứng",
  },
  {
    number: 6,
    symbol: "C",
    ...
    meltingPoint: "3825",
    boilingPoint: "4827",
    discoverer: "Thời cổ đại",
    yearDiscovered: "Cổ đại",
    description:
      "Nguyên tố cơ bản của sự sống, tồn tại ở nhiều dạng như kim cương.",
    applications:
      "Thép, kim cương công nghiệp, than hoạt tính, sợi carbon, graphene",
  },
  {
    number: 7,
    symbol: "N",
    ...
    applications:
      "Sản xuất phân bón, chất nổ, bảo quản thực phẩm, làm lạnh, khí trơ",
  },
  {
    number: 8,
    symbol: "O",
    ...
    applications:
      "Y tế (thở oxy), hàn cắt kim loại, tên lửa, xử lý nước thải, sản xuất thép",
  },
  {
    number: 9,
    symbol: "F",
    ...
    applications:
      "Kem đánh răng (fluoride), tủ lạnh (freon), teflon, thuốc gây mê, làm giàu uranium",
  },
  {
    number: 10,
    symbol: "Ne",
    ...
    applications:
      "Đèn neon quảng cáo, đèn huỳnh quang, laser, tivi màn hình plasma, làm lạnh cryogenic",
  },
  ...
  // Period 3
  {
    ...
    applications:
      "Muối ăn, xà phòng, đèn natri, làm mát lò phản ứng, sản xuất kim loại",
  },
  {
    number: 12,
    symbol: "Mg",
    ...
    applications:
      "Hợp kim nhẹ ô tô, máy bay, pháo hoa, thuốc chống acid, bổ sung dinh dưỡng",
  },
  {
    number: 13,
    symbol: "Al",
    ...
    yearDiscovered: "1825",
    description:
      "Kim loại nhẹ, bền và chống ăn mòn, dùng rộng rãi trong công nghiệp.",
    applications:
      "Lon nước ngọt, máy bay, ô tô, dây điện, nồi chảo, giấy bạc, xây dựng",
  },
  {
    number: 14,
    symbol: "Si",
    ...
    yearDiscovered: "1824",
    description:
      "Á kim quan trọng trong công nghệ bán dẫn và thành phần chính của cát.",
    applications:
      "Vi xử lý máy tính, pin mặt trời, thủy tinh, xi măng, silicon, chất bán dẫn",
  },
  {
    number: 15,
    symbol: "P",
    ...
    applications:
      "Phân bón, diêm, chất nổ, thuốc diệt chuột, chất tẩy rửa, thực phẩm chức năng",
  },
  {
    number: 16,
    symbol: "S",
    ...
    applications:
      "Axit sulfuric, lốp xe cao su, thuốc nổ, thuốc trừ sâu, diêm, mỹ phẩm",
  },
  {
    number: 17,
    symbol: "Cl",
    ...
    applications:
      "Khử trùng nước, chất tẩy trắng, PVC, thuốc trừ sâu, muối ăn, hồ bơi",
  },
  {
    number: 18,
    symbol: "Ar",
    ...
    applications:
      "Hàn kim loại, bóng đèn sợi đốt, bảo quản thực phẩm, laser, cửa sổ cách nhiệt",
  },
  ...
  },
  {
    ...
    yearDiscovered: "Cổ đại",
    description:
      "Kim loại quan trọng nhất trong công nghiệp, thành phần chính của thép.",
    applications:
      "Thép xây dựng, ô tô, tàu thuyền, máy móc, đinh ốc vít, hemoglobin máu",
  },
  {
    number: 27,
    symbol: "Co",
  ...
  },
  {
    ...
    applications:
      "Dây điện, ống nước, tiền xu, hợp kim đồng thau, mạch điện tử, nồi chảo",
  },
  {
    number: 30,
    symbol: "Zn",
  ...
  },
  {
    ...
    yearDiscovered: "1250",
    description:
      "Á kim độc, được sử dụng trong một số hợp kim và chất bán dẫn.",
  },
  {
    number: 34,
    symbol: "Se",
...
const remainingElements = [
  ...
  },
  {
    ...
    yearDiscovered: "1790",
    description:
      "Kim loại kiềm thổ, được sử dụng trong pháo hoa để tạo màu đỏ.",
  },
  {
    number: 39,
    symbol: "Y",
    ...
    yearDiscovered: "1794",
    description:
      "Kim loại chuyển tiếp hiếm, được sử dụng trong hợp kim và laser.",
  },
  {
    number: 40,
    symbol: "Zr",
    ...
    yearDiscovered: "1789",
    description:
      "Kim loại chuyển tiếp bền, chống ăn mòn, dùng trong lò phản ứng hạt nhân.",
  },
  {
    number: 41,
    symbol: "Nb",
    ...
    yearDiscovered: "1801",
    description:
      "Kim loại chuyển tiếp cứng, được sử dụng trong hợp kim siêu dẫn.",
  },
  {
    number: 42,
    symbol: "Mo",
  ...
  },
  {
    ...
    yearDiscovered: "1803",
    description:
      "Kim loại quý hiếm, được sử dụng trong chất xúc tác và trang sức.",
  },
  {
    number: 46,
    symbol: "Pd",
...
function getAccurateDensity(atomicNumber) {
  ...
  return (
    densities[atomicNumber] ||
    (atomicNumber >= 109
      ? "Chưa xác định tính chất hóa học"
      : atomicNumber > 92
      ? "Chưa xác định"
      : "~" + (atomicNumber * 0.2).toFixed(1))
  );
}
...
function getAccurateMeltingPoint(atomicNumber) {
  ...
  return (
    meltingPoints[atomicNumber] ||
    (atomicNumber >= 109
      ? "Chưa xác định tính chất hóa học"
      : atomicNumber > 92
      ? "Chưa xác định"
      : "~" + (atomicNumber * 20).toString())
  );
}
...
function getAccurateBoilingPoint(atomicNumber) {
  ...
  return (
    boilingPoints[atomicNumber] ||
    (atomicNumber >= 109
      ? "Chưa xác định tính chất hóa học"
      : atomicNumber > 92
      ? "Chưa xác định"
      : "~" + (atomicNumber * 40).toString())
  );
}

function getAccurateDiscoverer(atomicNumber) {
  const discoverers = {
    47: "Đã biết từ thời cổ đại",
    48: "Karl Samuel Leberecht Hermann",
    49: "Ferdinand Reich",
    50: "Đã biết từ thời cổ đại",
    51: "Thánh Albertus Magnus",
    52: "Franz-Joseph Müller von Reichenstein",
    53: "Bernard Courtois",
    54: "William Ramsay",
    55: "Robert Bunsen",
    ...
    72: "Dirk Coster",
    73: "Anders Gustaf Ekeberg",
    74: "Juan José Elhuyar",
    75: "Masataka Ogawa",
    76: "Smithson Tennant",
    77: "Smithson Tennant",
    78: "Antonio de Ulloa",
    79: "Đã biết từ thời cổ đại",
    80: "Đã biết từ thời cổ đại",
    81: "William Crookes",
    82: "Đã biết từ thời cổ đại",
    83: "Claude François Geoffroy",
    84: "Marie Curie",
    85: "Dale R. Corson",
    86: "Friedrich Ernst Dorn",
    87: "Marguerite Perey",
    88: "Pierre Curie",
    89: "André-Louis Debierne",
    90: "Jöns Jacob Berzelius",
    91: "Kasimir Fajans",
    92: "Martin Heinrich Klaproth",
  };
  return (
    discoverers[atomicNumber] ||
    (atomicNumber > 92 ? "Các nhà khoa học hiện đại" : "Nhà khoa học")
  );
}
...
function getAccurateYearDiscovered(atomicNumber) {
  ...
  return (
    years[atomicNumber] ||
    (atomicNumber > 92 ? (1940 + (atomicNumber - 93) * 2).toString() : "1800s")
  );
}
...
for (let i = 47; i <= 118; i++) {
  const elementData = {
    47: {
      ...
      position: [11, 5],
      applications:
        "Trang sức, tiền xu, nhiếp ảnh, gương, chất kháng khuẩn, mạch điện tử",
    },
    48: {
      symbol: "Cd",
      name: "Cadimi",
      ...
      position: [12, 5],
      applications:
        "Pin sạc, mạ chống ăn mòn, sơn, hợp kim hàn, tế bào quang điện",
    },
    49: {
      symbol: "In",
      name: "Inđi",
    ...
    50: {
      ...
      position: [14, 5],
      applications:
        "Hộp đồ hộp, hàn điện tử, hợp kim đồng thau, lá thiếc, chống ăn mòn",
    },
    51: {
      symbol: "Sb",
      name: "Antimon",
    ...
    53: {
      ...
      position: [17, 5],
      applications:
        "Thuốc sát trùng, muối ăn có iod, chụp X-quang, thuốc tuyến giáp, nhiếp ảnh",
    },
    54: {
      symbol: "Xe",
      name: "Xenon",
    ...
    79: {
      ...
      position: [11, 6],
      applications:
        "Trang sức, dự trữ tiền tệ, mạch điện tử, nha khoa, đầu tư, linh kiện máy tính",
    },
    80: {
      symbol: "Hg",
      name: "Thủy ngân",
    ...
    82: {
      ...
      position: [14, 6],
      applications:
        "Pin ô tô, chống tia X, đạn, hợp kim hàn, cân bằng bánh xe, sơn cũ",
    },
    83: {
      symbol: "Bi",
      name: "Bismut",
    ...
    92: {
      ...
      position: [6, 10],
      applications:
        "Nhiên liệu hạt nhân, vũ khí hạt nhân, tàu ngầm hạt nhân, y học hạt nhân, đồng hồ phóng xạ",
    },
    93: {
      symbol: "Np",
      name: "Neptuni",
